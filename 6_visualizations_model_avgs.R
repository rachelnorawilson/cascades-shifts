...
ggsave("figures/6_FigureS11_supp_model_preds_fire.pdf", multi.supp.fire.xy, width=10, height=8) 
...
ggsave("figures/6_FigureS15_supp_model_preds_nofire.pdf", multi.supp.nofire.xy, width=12, height=10) 
